...
<template>
  <div class="px-2 pb-16">
    ...
    <div class="container mx-auto max-w-7xl grid lg:grid-cols-3 md:grid-cols-2 sm:grid-cols-1">
      <Note v-for="note in noteStore.noteList" :title="note.title" :id="note.id" />
    </div>
  </div>
</template>
